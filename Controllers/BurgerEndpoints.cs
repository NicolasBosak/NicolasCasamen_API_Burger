...
namespace API_Burger.NicolasCasamen.Controllers;
...
public static class BurgerEndpoints
{
    public static void MapBurgerEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/", async (API_BurgerNicolasCasamenContext db) =>
        {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<Burger>, NotFound>> (int id, API_BurgerNicolasCasamenContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int id, Burger burger, API_BurgerNicolasCasamenContext db) =>
        {
        ...
        group.MapPost("/", async (Burger burger, API_BurgerNicolasCasamenContext db) =>
        {
        ...
        group.MapDelete("/{id}", async Task<Results<Ok, NotFound>> (int id, API_BurgerNicolasCasamenContext db) =>
        {
            var affected = await db.Burger
                .Where(model => model.Id == id)
                .ExecuteDeleteAsync();
